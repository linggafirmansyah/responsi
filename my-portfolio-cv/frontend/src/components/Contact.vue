  ...
  <footer id="kontak" class="py-20 bg-gray-800 text-white">
    <div class="container mx-auto px-6 text-center">
      ...
      <div class="flex justify-center space-x-6 mb-8">
        <a
          href="https://github.com/linggafirmansyah/"
          target="_blank"
        ...
        <a
          href="https://www.instagram.com/link_emon"
          target="_blank"
          class="text-gray-400 hover:text-white transition-colors duration-300"
        >
          Instagram
        ...
        <a
          href="https://www.tiktok.com/@monzee_22"
          target="_blank"
          class="text-gray-400 hover:text-white transition-colors duration-300"
        >
          TikTok
      ...
      <p class="text-gray-500">
        &copy; {{ new Date().getFullYear() }} Lingga Firmansyah. Dibuat dengan hati.
      </p>
    </div>
  </footer>
</template>
